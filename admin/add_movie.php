...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql  = "INSERT INTO movies (title, duration, genre, language, certification, synopsis, director, release_date, rating, status, formats, trailer_url, poster_image, is_rerelease) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
...
<head>
    ...
    <title>Add New Movie - CineBook Admin</title>
        ...
        <div class="flex-1 overflow-y-auto p-8 custom-scrollbar">
            ...
            <div class="max-w-4xl mx-auto w-full">
                <header class="mb-8 flex items-center gap-4">
                    ...
                    <div>
                        <h1 class="text-3xl font-bold mb-1 text-gray-900 dark:text-white">Add New Movie</h1>
                        <p class="text-gray-500 dark:text-textMuted text-sm">Fill in the details to add a new movie to the system</p>
                    </div>
                </header>
                    ...
                    <form id="add-movie-form" action="add_movie.php" method="POST" enctype="multipart/form-data" class="space-y-6">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
                            <div>
                                ...
                                <input type="text" name="title" required placeholder="Movie title" class="w-full bg-gray-50 dark:bg-inputBg border border-gray-200 dark:border-inputBorder text-gray-900 dark:text-white rounded-lg p-3 text-sm focus:border-brand focus:outline-none placeholder-gray-400 transition-colors">
                            </div>
                            <div>
                                <label class="block text-sm font-bold mb-2 text-gray-900 dark:text-white">Duration <span class="text-red-500">*</span></label>
                                <input type="text" name="duration" required placeholder="e.g., 180 min" class="w-full bg-gray-50 dark:bg-inputBg border border-gray-200 dark:border-inputBorder text-gray-900 dark:text-white rounded-lg p-3 text-sm focus:border-brand focus:outline-none placeholder-gray-400 transition-colors">
                            </div>
                        </div>

                        <div>
                            <label class="block text-sm font-bold mb-2 text-gray-900 dark:text-white">Genre <span class="text-red-500">*</span></label>
                            <input type="text" name="genre" required placeholder="Action, Drama, Sci-Fi (comma separated)" class="w-full bg-gray-50 dark:bg-inputBg border border-gray-200 dark:border-inputBorder text-gray-900 dark:text-white rounded-lg p-3 text-sm focus:border-brand focus:outline-none placeholder-gray-400 transition-colors">
                        </div>

                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
                            <div>
                                <label class="block text-sm font-bold mb-2 text-gray-900 dark:text-white">Language</label>
                                <input type="text" name="language" placeholder="English, Hindi (comma separated)" class="w-full bg-gray-50 dark:bg-inputBg border border-gray-200 dark:border-inputBorder text-gray-900 dark:text-white rounded-lg p-3 text-sm focus:border-brand focus:outline-none placeholder-gray-400 transition-colors">
                            </div>
                            <div>
                        ...
                        <div>
                            ...
                            <textarea name="synopsis" rows="4" placeholder="Movie synopsis..." class="w-full bg-gray-50 dark:bg-inputBg border border-gray-200 dark:border-inputBorder text-gray-900 dark:text-white rounded-lg p-3 text-sm focus:border-brand focus:outline-none placeholder-gray-400 transition-colors resize-none"></textarea>
                        </div>

                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
                            <div>
                                <label class="block text-sm font-bold mb-2 text-gray-900 dark:text-white">Director</label>
                                <input type="text" name="director" placeholder="Director name" class="w-full bg-gray-50 dark:bg-inputBg border border-gray-200 dark:border-inputBorder text-gray-900 dark:text-white rounded-lg p-3 text-sm focus:border-brand focus:outline-none placeholder-gray-400 transition-colors">
                            </div>
                            <div>
                                <label class="block text-sm font-bold mb-2 text-gray-900 dark:text-white">Release Date</label>
                                <input type="text" id="add-release-date" name="release_date" placeholder="e.g., 2024-07-21" class="w-full bg-gray-50 dark:bg-inputBg border border-gray-200 dark:border-inputBorder text-gray-900 dark:text-white rounded-lg p-3 text-sm focus:border-brand focus:outline-none placeholder-gray-400 transition-colors">
                            </div>
                        </div>
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
                            <div>
                                ...
                                <input type="text" name="rating" placeholder="e.g. 8.5" class="w-full bg-gray-50 dark:bg-inputBg border border-gray-200 dark:border-inputBorder text-gray-900 dark:text-white rounded-lg p-3 text-sm focus:border-brand focus:outline-none placeholder-gray-400 transition-colors">
                            </div>
                            <div>
                                ...
                                <input type="hidden" name="status" id="add-status-hidden" value="">
                                <div id="add-status-badge" class="w-full bg-gray-50 dark:bg-inputBg border border-gray-200 dark:border-inputBorder rounded-lg p-3 text-sm font-bold transition-colors text-gray-400 dark:text-gray-500">
                                    Enter release date to detect
                                </div>
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <input type="text" name="formats" placeholder="IMAX, Dolby Cinema, Standard (comma separated)" class="w-full bg-gray-50 dark:bg-inputBg border border-gray-200 dark:border-inputBorder text-gray-900 dark:text-white rounded-lg p-3 text-sm focus:border-brand focus:outline-none placeholder-gray-400 transition-colors">
                        </div>
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <label for="m-poster" class="w-full flex items-center justify-center gap-2 cursor-pointer bg-gray-50 dark:bg-inputBg hover:bg-gray-100 dark:hover:bg-borderMain text-gray-900 dark:text-white font-semibold py-3 px-4 border border-dashed border-gray-300 dark:border-gray-600 rounded-lg transition-colors text-sm h-28">
                                    ...
                                    <span id="file-name-display" class="text-gray-500">Click to upload poster image</span>
                                </label>
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <input type="url" name="trailer_url" placeholder="https://www.youtube.com/embed/..." class="w-full bg-gray-50 dark:bg-inputBg border border-gray-200 dark:border-inputBorder text-gray-900 dark:text-white rounded-lg p-3 text-sm focus:border-brand focus:outline-none placeholder-gray-400 transition-colors">
                        </div>
                        ...
                        <div class="border border-gray-200 dark:border-borderMain rounded-xl p-5 space-y-4 mt-6 bg-gray-50 dark:bg-[#0c0c0c]">
                            ...
                            <div id="trailer-fields-container" class="space-y-3"></div>
                        ...
                        <div class="space-y-4 mt-10">
                            ...
                            <div id="cast-fields-container" class="space-y-4"></div>
                            <button type="button" onclick="addCastMember()" class="w-full mt-2 py-3 rounded-lg bg-transparent text-yellow-600 dark:text-brand border border-yellow-600 dark:border-brand text-sm font-bold hover:bg-yellow-50 dark:hover:bg-brand/10 transition-colors flex justify-center items-center gap-2">
                                <i data-lucide="plus" class="w-4 h-4"></i> Add Cast Member
                            </button>
                        </div>
                        ...
                        <div class="space-y-4 mt-10">
                            ...
                            <div id="crew-fields-container" class="space-y-4"></div>
                            <button type="button" onclick="addCrewMember()" class="w-full mt-2 py-3 rounded-lg bg-transparent text-yellow-600 dark:text-brand border border-yellow-600 dark:border-brand text-sm font-bold hover:bg-yellow-50 dark:hover:bg-brand/10 transition-colors flex justify-center items-center gap-2">
                                <i data-lucide="plus" class="w-4 h-4"></i> Add Crew Member
                            </button>
                        </div>
    ...
    <script>
        ...
        function updateFileName(input) {
            ...
            if (input.files && input.files.length > 0) {
                ...
                displaySpan.classList.add('text-brand');
            } else {
                displaySpan.textContent = 'Click to upload poster image';
                displaySpan.classList.add('text-gray-500');
                displaySpan.classList.remove('text-brand');
            }
        }
        ...
        function addTrailerRow(lang = '', url = '') {
            ...
            row.className = "trailer-row flex items-center gap-3 border-b border-gray-200 dark:border-gray-800 pb-3 last:border-none last:pb-0 mt-3";
            row.innerHTML = `
        ...
        const addReleaseDateInput = document.getElementById('add-release-date');
        const addStatusHidden     = document.getElementById('add-status-hidden');
        const addStatusBadge      = document.getElementById('add-status-badge');

        function updateAddStatusFromDate() {
            const dateStr = addReleaseDateInput.value.trim();
            if (!dateStr) {
                addStatusBadge.textContent = 'Enter release date to detect';
                addStatusBadge.className = 'w-full bg-gray-50 dark:bg-inputBg border border-gray-200 dark:border-inputBorder rounded-lg p-3 text-sm font-bold transition-colors text-gray-400 dark:text-gray-500';
                return;
            }
            const parsed = new Date(dateStr);
            if (isNaN(parsed.getTime())) {
                addStatusBadge.textContent = 'Invalid date format';
                addStatusBadge.className = 'w-full bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-lg p-3 text-sm font-bold transition-colors text-red-500';
                return;
            }
            ...
            if (parsed <= today) {
                addStatusHidden.value = 'Now Showing';
                addStatusBadge.textContent = '● Now Showing';
                addStatusBadge.className = 'w-full bg-emerald-50 dark:bg-emerald-900/20 border border-emerald-200 dark:border-emerald-800 rounded-lg p-3 text-sm font-bold transition-colors text-emerald-600 dark:text-emerald-400';
            } else {
                addStatusHidden.value = 'Coming Soon';
                addStatusBadge.textContent = '● Coming Soon';
                addStatusBadge.className = 'w-full bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-3 text-sm font-bold transition-colors text-blue-600 dark:text-blue-400';
            }
        }

        addReleaseDateInput.addEventListener('input', updateAddStatusFromDate);
        addReleaseDateInput.addEventListener('change', updateAddStatusFromDate);

        // Initialize with one empty row for each dynamic section
